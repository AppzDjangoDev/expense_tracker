    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default='2023-06-12')),
                ('end_date', models.DateField(default='2023-06-12')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorytype', models.CharField(choices=[('income', 'INCOME'), ('expense', 'EXPENSE')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('date', models.DateField(default='2023-06-12')),
